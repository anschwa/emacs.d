;; Base3 Dark 
;; Scheme: Modified Base16 Theme (https://github.com/chriskempson/base16)

;; Inspiration: (https://www.robertmelton.com/2016/03/13/syntax-highlighting-off/)
...
(let ((base00 "#2d2d2d")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:background ,base02 :foreground ,base05 :box nil))))
   ...
   `(font-lock-string-face ((t (:foreground ,base0B :weight normal))))
   ...
   `(line-number ((t (:inherit (shadow default) :foreground ,base02))))

   ;; Search
   `(match ((t (:foreground ,base0D :background ,base01 :inverse-video t))))
   `(isearch ((t (:foreground ,base0A :background ,base01 :inverse-video t))))
   `(isearch-lazy-highlight-face ((t (:foreground ,base0D :background ,base01 :inverse-video t))))
   `(isearch-fail ((t (:background ,base01 :inherit font-lock-warning-face :inverse-video t))))

   ;; ace-window mode
   `(aw-leading-char-face ((((class color)) (:foreground ,base0A))
                           (((background dark)) (:foreground ,base07))
                           (((background light)) (:foreground ,base00))
                           (t (:foreground ,base07 :underline nil))))
   `(avy-lead-face ((t (:foreground ,base00 :background ,base0A))))

   ;; flyspell-mode
   `(flyspell-incorrect ((t (:inherit nil :underline (:color ,base08 :style wave)))))
   `(flyspell-duplicate ((t (:inherit nil :underline (:color ,base09 :style wave)))))
   ...
   `(ido-first-match ((t (:foreground ,base0B))))
   ...
   `(show-paren-match ((t (:background ,base0B :foreground ,base03))))
   ...
   ;; dired
   `(dired-directory ((t (:foreground ,base0D))))
   `(dired-header ((t (:foreground ,base0A))))
   `(dired-mark ((t (:foreground ,base09))))
   ...
   ;; company-mode
   `(company-tooltip ((t (:background ,base03 :foreground ,base06))))
   `(company-scrollbar-bg ((t (:background ,base03))))
   `(company-scrollbar-fg ((t (:background ,base0E))))
   `(company-tooltip-selection ((t (:background ,base0D))))
   `(company-tooltip-common ((t (:background ,base03 :foreground ,base0A))))
   `(company-tooltip-common-selection ((t (:inherit company-tooltip-selection :foreground nil))))
   `(company-tooltip-annotation ((t (:inherit company-tooltip :foreground ,base09))))
   `(company-preview ((t (:background nil :foreground ,base04))))
   `(company-preview-common ((t (:background nil :foreground ,base04))))

   ;; idris-mode
   `(idris-semantic-type-face ((t (:foreground ,base0D))))
   `(idris-semantic-bound-face ((t (:foreground base0E))))

   ;; markdown-mode
   `(markdown-blockquote-face ((t (:inherit font-lock-doc-face :foreground ,base0F :height 0.8))))
   `(markdown-bold-face ((t (:inherit font-lock-variable-name-face :foreground ,base0A :weight bold))))
   ...
   `(markdown-italic-face ((t (:inherit font-lock-variable-name-face :foreground ,base0E :slant italic))))
  ...
  (custom-theme-set-variables
   ...
   `(ansi-term-color-vector
     ;; black, base08, base0B, base0A, base0D, magenta, cyan, white
     [default ,base00 ,base08 ,base0B ,base0A ,base0D ,base0E ,base0D ,base05])))

(provide-theme 'base3-dark)

;;; base3-dark-theme.el ends here
